...
const consultationTypes = [
  { type: "In-Person", icon: <Stethoscope size={20} /> },
  { type: "Video Consultation", icon: <Video size={20} /> },
  { type: "Both", icon: <Phone size={20} /> }
];
...
export function Consultations() {
  ...
  const [healthAssessmentData, setHealthAssessmentData] = useState({
    age: "",
    lastPeriod: "",
    cycleLength: "",
    symptoms: [],
  ...
  const DoctorCard = ({ doctor, healthConcerns }) => (
    <motion.div
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-2xl w-full">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              type="number"
              value={healthAssessmentData.age}
              onChange={(e) => setHealthAssessmentData({...healthAssessmentData, age: e.target.value})}
              className="w-full p-2 border rounded"
            />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">Last Period Date</label>
            <input
              type="date"
              value={healthAssessmentData.lastPeriod}
              onChange={(e) => setHealthAssessmentData({...healthAssessmentData, lastPeriod: e.target.value})}
              className="w-full p-2 border rounded"
            />
          </div>
          <div>
            ...
            <input
              type="number"
              value={healthAssessmentData.cycleLength}
              onChange={(e) => setHealthAssessmentData({...healthAssessmentData, cycleLength: e.target.value})}
              className="w-full p-2 border rounded"
            />
          </div>
          <div>
        ...
        <div className="container mx-auto py-8 px-4">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              >
                Expert Women's Health Consultations
              </motion.h2>
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors duration-300"
              >
                <Activity size={20} className="text-white" />
                <span className="text-white font-medium">Health Assessment</span>
              </button>
              <button
          ...
          {showHealthAssessment && <HealthAssessmentModal />}
          ...
          {isLoaded && (
            ...
            >
              <h2 className="text-2xl font-semibold mb-4 dark:text-white">
                Find Specialized Women's Health Experts
              </h2>
